...
hour = floor( Fr * 24 );
minut = floor( abs( hour -( Fr * 24 ) ) * 60 );
minufrac = ( abs( hour - ( Fr * 24 ) ) * 60 ); 
sec = ceil( abs( minut - minufrac ) * 60);
if sec == 60;   sec = 0; minut = minut+1; end
if minut == 60; minut = 0; hour = hour+1; end
if hour == 24;   hour = 0; day = day+1; end
format('long', 'g');
dategreg = [day month year hour minut sec];
